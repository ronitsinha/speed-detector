...
def segmentation_v2 (binary):
	...
	linesP = cv2.HoughLinesP(dilation, 1, np.pi / 180, 20, None, MIN_LINE_LENGTH
				, MAX_LINE_GAP)
...
with a random color. The final areas of each lane are stored in the "lanes"
list.
"""
def assign_lanes(out, border_x, border_y):
	...
	# 50 points in the array there is a new polynomial, i.e. a new lane.
	...
	# Fill in the space between the lanes (where the cars actually drive) in a 
	# random color, for demonstration and testing purposes.
	for lane in lanes:
...
if __name__ == '__main__':
	...
	out = segmentation_v2(color_mask)
